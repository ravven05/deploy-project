...
const EditProduct = () => {
  ...
  return (
    ...
    {product ? (
       ...
       <input type="text" value={product.name} placeholder='Title' name='name' onChange={handleInp}/>
       <input type="text" value={product.description} placeholder='Description' name='description' onChange={handleInp}/>
       <input type="number" value={product.price} placeholder='Price' name='price' onChange={handleInp}/>
